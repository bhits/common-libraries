...
public class XdsbRepositoryAdapterIT {
    ...
    public void testProvideAndRegisterDocumentSet_CCDA11() throws Exception {
        RegistryResponseType response = xdsbRepositoryAdapter.documentRepositoryRetrieveDocumentSet(CCDA11, OPENEMPI_GLOBAL_DOMAIN_ID, XDSB_DOCUMENT_TYPE_CLINICAL_DOCUMENT);
    ...
    public void testProviderAndRegisterDocumentSet_CCDA20()  throws Exception {
        RegistryResponseType response = xdsbRepositoryAdapter.documentRepositoryRetrieveDocumentSet(CCDA20, OPENEMPI_GLOBAL_DOMAIN_ID, XDSB_DOCUMENT_TYPE_CLINICAL_DOCUMENT);
    ...
    public void testProviderAndRegisterDocumentSet_CCDA21() throws Exception {
        RegistryResponseType response = xdsbRepositoryAdapter.documentRepositoryRetrieveDocumentSet(CCDA21, OPENEMPI_GLOBAL_DOMAIN_ID, XDSB_DOCUMENT_TYPE_CLINICAL_DOCUMENT);
